...
const HISTORICAL_CASES: Array[Dictionary] = [
	...
	{"sim_index": 46, "seed": 925275, "team_a": ["bastionne", "nyxa", "cashmere", "orielle"], "team_b": ["bo", "hexeon", "omenry", "quillith"]},
	{"sim_index": 81, "seed": 931777, "team_a": ["gable", "cinder", "orielle"], "team_b": ["juno_vale", "kett", "cashmere", "hexeon"]},
	{"sim_index": 83, "seed": 931778, "team_a": ["gable", "cinder", "orielle"], "team_b": ["juno_vale", "kett", "cashmere", "hexeon"]},
