...
func _assert_dense_combat_readability_contract(combat: Control, manager: CombatManager) -> void:
	...
	_expect(arena != null and String(arena.get_meta("combat_presentation_bounds_contract", "")) == "actor_and_readout_extents_contained", "dense combat review lacks an actor/readout hard-clip containment contract")
