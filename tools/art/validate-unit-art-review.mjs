...
console.log("UNIT_ART_REVIEW_STATIC: PASS curated=30 mara=17 sable-reviews=8 pilfer-reviews=1 archive=33 phase2-units=12 canonical=mara pins=5 active-review=1");
